...
st.markdown("Welcome to my web app, where we explore the incredible advancements of **AI** in the healthcare space.")
...
st.markdown("My web app utilizes a state-of-the-art Machine Learning model designed for early disease prediction based on the analysis of human nails. The model is trained to recognize patterns and abnormalities in nail images, providing valuable insights into potential health issues.")
...
st.markdown("Navigate through the sidebar to learn more about me, our project, and how to get in touch. Feel free to explore the exciting world of AI in healthcare and discover the potential of early disease prediction.")
